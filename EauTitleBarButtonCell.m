...
- (void)drawButtonInRect:(NSRect)frame
{
    ...
    // Create path with rounded corner only on outer edge
    ...
    if (_buttonPosition == EauTitleBarButtonPositionLeft) {
        ...
        [topLine stroke];
    } else if (_buttonPosition == EauTitleBarButtonPositionRightOuter) {
        ...
        [topLine setLineWidth:1.0];
        [topLine stroke];
    } else if (_buttonPosition == EauTitleBarButtonPositionRightInner) {
